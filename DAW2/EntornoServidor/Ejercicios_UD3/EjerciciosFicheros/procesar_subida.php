...
echo "Nombre del primer fichero".$_FILES["fichero1"]["name"];
echo "<br>Nombre temporal del fichero en el servidor: ".$_FILES["fichero1"]["tmp_name"]."<br>"."<br>";

// hay que crear el directorio
$res1 = move_uploaded_file ($_FILES["fichero1"]["tmp_name"], 
                                "subidos/".$_FILES["fichero1"]["name"]);

echo "Nombre del primer fichero".$_FILES["fichero2"]["name"];
echo "<br>Nombre temporal del fichero en el servidor: ".$_FILES["fichero2"]["tmp_name"]."<br>";
